...
const About = () => {
  return (
    <div>
        <section className='about' style={{ backgroundImage: "url(01.jpg)"}}>
            <div className='about-cont'>
                <h2 className='fade-in'>About Us</h2>
                <p>Welcome to Awesome Watches

Discover the perfect blend of style precision and craftsmanship with Awesome Watches. We offer an exclusive collection of timepieces designed for those who value elegance and functionality. Whether you&aposre looking for a sleek modern design a classic vintage style or a rugged sports watch we have something for everyone.
